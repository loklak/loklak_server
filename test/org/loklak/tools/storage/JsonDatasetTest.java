...
public class JsonDatasetTest extends TestCase {
	...
	public void test() throws IOException {
		...
		for (JsonRepository.Mode mode : JsonRepository.Mode.values())
			try {

				// write the file
				JsonDataset dtst = new JsonDataset(this.testFile, "idx_",
						new Column[] { new Column("abc", true), new Column("def", false) }, null, null, mode, false,
						Integer.MAX_VALUE);
				...
				// read the file
				dtst = new JsonDataset(this.testFile, "idx_",
						new Column[] { new Column("abc", true), new Column("def", false) }, null, null, mode, false,
						Integer.MAX_VALUE);
