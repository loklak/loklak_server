...
public class CampaignServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (query.length() == 0) {
            response.sendError(400, "you must submit a property 'query' with a search query to identify messages for the campaign");
            return;
        }
        ...
        if (timezoneOffset == -999) {
            response.sendError(400, "you must submit a property 'timezoneOffset' with the offset of your time zone in minutes");
            return;
        }
