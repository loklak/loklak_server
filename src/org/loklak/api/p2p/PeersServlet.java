...
public class PeersServlet extends HttpServlet {
	...
	public static Timeline peers(final String protocolhostportstub, final String query, final Timeline.Order order,
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (classes.length == 0)
			classes = new String[] { "HelloServlet", "SuggestServlet" };
		...
		// String pingback = qm == null ? request.getParameter("pingback") :
		// qm.get("pingback");
		// pingback may be either filled with nothing, the term 'now' or the
		// term 'later'
