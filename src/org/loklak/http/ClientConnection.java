...
public class ClientConnection {
	...
	private static RequestConfig defaultRequestConfig = RequestConfig.custom().setSocketTimeout(60000)
			.setConnectTimeout(60000).setConnectionRequestTimeout(60000).setContentCompressionEnabled(true)
	...
	/**
	 * get a redirect for an url: this method shall be called if it is expected
	 * that a url is redirected to another url. This method then discovers the
	 * redirect.
	 * 
	 * @param urlstring
	 * @param useAuthentication
