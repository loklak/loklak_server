...
public class IntegerGeoPoint extends AbstractGeoPoint implements GeoPoint {
	...
	private final long latlon; // using one variable for the coordinate pair
								// saves some space
	...
	/**
	 * compute the hash code of a coordinate this produces identical hash codes
	 * for locations that are close to each other
	 */
	@Override
	public int hashCode() {
	...
	public static void main(String[] args) {
		...
		System.out.println("error: lat: " + (Math.abs(c.lat() - lat) / meter) + " meter; lon: "
				+ (Math.abs(c.lon() - lon) / meter) + " meter");
		System.out.println("accuracyLat = " + c.accuracyLat() / meter + " meter, accuracyLon = "
				+ c.accuracyLon() / meter + " meter");
	}
}
