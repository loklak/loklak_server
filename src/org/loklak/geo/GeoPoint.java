 ...
 * The reason to have different implementation is to save memory for the point
 * storage. With each version of a point storage comes a accuracy level which
 * can be returned by the object.
 */
public interface GeoPoint {

	public static final double meter = 90.0d / 1.0e7d; // this is actually the
														// definition of
														// 'meter': 10 million
														// meter shall be the
														// distance from the
