...
/**
 * High-efficient GeoJson parser (high-efficient because it is able to handle
 * very large input files, much larger than the main memory can hold (i.e.
 * terabytes) using a stream parser within a multi-core environment. Parsed
 * feature records can be processed concurrently while the parser is
 * stream-reading them.
 */
