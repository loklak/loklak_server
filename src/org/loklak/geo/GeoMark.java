...
public class GeoMark extends GeoLocation implements GeoPoint {
	...
	public GeoMark(final GeoLocation loc, final String salt) {
		...
		// example city: middle-high density city (10,000 persons per square
		// kilometer)
		// a large city in that density is Seoul, South Korea: 23,480,000
		// persons on 2,266 square kilometer
		...
		// we don't compute a random number for the actual fuzzy location of the
		// marker
		...
		double dist = (h & 0xff) * r / 255.0d / 40000000 * 360; // 40 million
																// meter (the
																// earth) has an
																// angle of 360
																// degree
