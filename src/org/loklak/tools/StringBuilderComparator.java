...
/**
 * case-insensitive compare of two StringBuilder objects this shall replace the
 * corresponding method in class String when StringBuilder objects are not
...
public class StringBuilderComparator implements Comparator<StringBuilder> {
	...
	public StringBuilder[] split(final StringBuilder sb, final char c) {
		...
		for (int i = 0; i < resultSize; i++)
			result[i] = new StringBuilder(list.get(i));
		return result;
	}
