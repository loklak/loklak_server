...
/**
 * this is a replacement of an insensitive collator object, produced by a
 * RuleBasedCollator Class The RuleBasedCollator is a very inefficient class if
 * it is used only for insensitive ASCII comparisments This class is a very
 * simple comparator for Strings which can be used to compare also Strings with
 * upper/lowercase Strings without applying .toUpperCase or .toLowerCase Strings
 * must contain no other than ASCII code.
 */
