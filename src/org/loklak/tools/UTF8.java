...
public class UTF8 {
	...
	/**
	 * using the string method with the default charset given as argument should
	 * prevent using the charset cache in FastCharsetProvider.java:118 which
	 * locks all concurrent threads using a UTF8.String() method
	 * 
	 * @param bytes
	 * @return
	 */
	 ...
	 * Charset object for the default charset as given with a default charset
	 * name. With our call using a given charset object, the call is much easier
	 * to perform and it omits the synchronization for the charset lookup.
	 *
	 * @param s
	 * @return
	 */
