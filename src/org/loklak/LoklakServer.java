...
public class LoklakServer {
    ...
    private static void setServerHandler(File dataFile){
        ...
        servletHandler.addServlet(EventBriteCrawlerService.class, "/api/eventbritecrawler.json");
        servletHandler.addServlet(GithubProfileScraper.class, "/api/githubprofilescraper.json");
        servletHandler.addServlet(LocationWiseTimeService.class, "/api/locationwisetime.json");
        servletHandler.addServlet(MeetupsCrawlerService.class, "/api/meetupscrawler.json");
        servletHandler.addServlet(RSSReaderService.class,  "/api/rssreader.json");
        servletHandler.addServlet(TimeAndDateService.class, "/api/timeanddate.json");
        servletHandler.addServlet(WordpressCrawlerService.class, "/api/wordpresscrawler.json");
        servletHandler.addServlet(InstagramProfileScraper.class, "/api/instagramprofilescraper.json");
        servletHandler.addServlet(WikiGeoData.class, "/api/wikigeodata.json");
