	...
	public ImportProfileEntry(JSONObject json) {
		...
		try {
			...
			throw new IllegalArgumentException(
					"harvesting_freq value not permitted : " + json.getLong("harvesting_freq"));
		}
		this.lifetime = json.getLong("lifetime");
		this.imported = new ArrayList<>();
		for (Object o : json.getJSONArray("imported"))
			this.imported.add((String) o);
		this.sharers = new ArrayList<>();
		for (Object o : json.getJSONArray("sharers"))
			this.sharers.add((String) o);
