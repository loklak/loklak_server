...
public class UserEntry extends AbstractObjectEntry implements ObjectEntry {
	...
	public final static String field_screen_name = "screen_name"; // used as id
																	// of the
																	// record
	public final static String field_user_id = "user_id"; // to reference the id
															// of the providing
															// service (here:
															// twitter)
	...
	public UserEntry(String user_id, String screen_name_raw, String profile_image_url, String name_raw) {
		...
		this.map.put(
				profile_image_url.startsWith("https:") ? field_profile_image_url_https : field_profile_image_url_http,
				profile_image_url);
	...
	public String getName() {
		return MessageEntry.html2utf8(parseString((String) this.map.get(field_name))); // html2utf8
																						// should
																						// not
																						// be
																						// necessary
	...
	public static void main(String args[]) {
		...
		// String j = "{\"name\":\"Mr.
		// Test\",\"screen_name\":\"test\",\"profile_image_url\":\"http://test.com\"}";
	}
}
