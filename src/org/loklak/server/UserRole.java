...
public class UserRole {
	 ...
	 *
	 * @param name
	 *            the key in the sourceObject
	 * @param baseUserRole
	 * @param parent
	 *            if a parent user role exists
	 * @param sourceObject
	 *            JSONObject in some storage file. Write changes here if exist
	 */
	public UserRole(@Nonnull String name, @Nonnull BaseUserRole baseUserRole, UserRole parent,
	...
	public String getDisplayName() {
		return json.getString("display-name");
	}
	...
	public JSONObject getPermissionOverrides(String servletCanonicalName) {
		if (permissions.has(servletCanonicalName))
			return permissions.getJSONObject(servletCanonicalName);
		return null;
	}
